...
INSERT INTO application_details (application, value, details_key) VALUES (1, '[{"type":"measure","config":{"enabled":false}},{"type":"print","config":{"enabled":false}}]', 'components');
...
INSERT INTO geo_service (protocol, id, authorizations_modified, monitoring_enabled, monitoring_statusok, name, password, url, username, tiling_protocol, exception_type, override_url, category, top_layer, geofence_header, version) VALUES ('wms', 4, '2018-11-22 13:34:29.301', false, true, 'woonplaatsen', 'w@chtw00rd', 'https://flamingo5.b3p.nl/geoserver/test_omgeving_fla5/wms', 'B3P', NULL, 'Inimage', false, 2, 1, NULL, '1.1.1');
